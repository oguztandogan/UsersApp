...
final class LoggingInterceptor: InterceptorProtocol, Sendable {
    ...
    private func getRequestStartTime(from request: URLRequest) -> Date? {
        // In a real implementation, you might store this in a thread-safe way
        // For now, return nil
        return nil
    }
}
...
// MARK: - Default NetworkLogger Implementation
final class DefaultNetworkLogger: NetworkLogger, Sendable {
    ...
    func log(_ message: String, level: LoggingInterceptor.LogLevel) {
        ...
        // or write to a file instead of just printing
    }
}

// MARK: - FileNetworkLogger Implementation
final class FileNetworkLogger: NetworkLogger, Sendable {
    private let fileURL: URL
    private let maxFileSize: Int
    private let dateFormatter: DateFormatter

    init(fileURL: URL, maxFileSize: Int = 10 * 1024 * 1024) { // 10MB default
...
extension LoggingInterceptor {
    /// Creates a logging interceptor for development environment
    ...
    /// Creates a logging interceptor for production environment
    ...
    /// Creates a logging interceptor with custom file logging
